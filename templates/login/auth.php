...
<form action="" class="login-form user_action_form">
    ...
    <button type="button" class="mt-2 btn btn--gold-border btn--size-lg btn--block" data-rout="<?php echo rest_url(IXPC_REST_ROUT_PREFIX.'register/'); ?>">
        регистрация
    </button>
    <button type="button" class="mt-2 btn btn--gold-border btn--size-lg btn--block" data-rout="<?php echo rest_url(IXPC_REST_ROUT_PREFIX.'reminder/'); ?>">
        восстановить пароль
    </button>
</form>
